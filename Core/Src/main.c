...
osThreadId CAN_TransmitHandle;
osThreadId UART_ReceptionHandle;
osThreadId UART_TransmitHandle;
osThreadId MUX_PRESHandle;
/* USER CODE BEGIN PV */
...
extern void uart_notifications_cycle(void const * argument);
extern void uart_logger_cycle(void const * argument);
extern void mux_pres_cycle(void const * argument);
...
/* USER CODE BEGIN Header_can_logger_cycle */
/**
  * @brief  Function implementing the CAN_Transmissio thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_can_logger_cycle */
__weak void can_logger_cycle(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
